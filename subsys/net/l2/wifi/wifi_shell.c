...
SHELL_STATIC_SUBCMD_SET_CREATE(wifi_commands,
	...
	SHELL_CMD(scan, NULL,
		  "Scan for Wi-Fi APs\n"
		    "OPTIONS:\n"
		    "[-t, --type <active / passive>] : Preferred mode of scan. The actual mode of scan can depend on factors such as the Wi-Fi chip implementation, regulatory domain restrictions etc.",
		  cmd_wifi_scan),
